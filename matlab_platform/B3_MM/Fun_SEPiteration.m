...
% 教学操作说明：稳定平衡点的迭代计算函数
% 使用方法：
%  按以下函数签名调用：function [SEP,omegacoi,flag_iter,n_iter]=Fun_SEPiteration(Y_red,Pm,E,m,d,delta0,omega0,omegab,n_itermax,Tolerr)
% 参数：
...
% =========================================================================
function [SEP,omegacoi,flag_iter,n_iter]=Fun_SEPiteration(Y_red,Pm,E,m,d,delta0,omega0,omegab,n_itermax,Tolerr)
